        ...
        <section className='max-w-[1000px] mx-auto' style={{paddingTop: '60px'}}>
          <div className="flex">
            <div className="w-1/2 p-4 max-w-[50%] flex items-center justify-center flex-col">
              ...
              <p className='pt-10 max-w-[327px] text-center'>Dinh Độc Lập được công nhận là Di tích lịch sử văn hóa quốc gia bằng Quyết định số 77A/VHQĐ ngày 25/6/1976 của Bộ trưởng Bộ Văn hóa. Ngày 12 tháng 8 năm 2009, Thủ tướng Chính phủ nước Cộng hòa Xã hội Chủ nghĩa Việt Nam đã ký...</p>
              <Link to='/gioi-thieu'>
                <button style={{ height: '50px', width: '112px', marginTop:'40px' }} className='bg-[#C1A559] p-[10px]' >ĐỌC THÊM</button>
              </Link>
              <img style={{ marginTop:'40px' }}src={Homepage360} alt="Homepage360" />
              <Link to='/mo-hinh'>
                <button style={{ height: '50px', width: '112px', marginTop:'40px' }} className='bg-[#C1A559] p-[10px]' >VR360</button>
              </Link>
            </div>
        ...
        <div style={{paddingTop: '90px', paddingBottom: '10px'}}>
          <div className='flex position: relative items-center justify-center'>
            ...
            <div className='position: absolute justify-center items-center text-center max-w-[40%] text-white flex flex-col'>
              ...
              <button style={{ height: '50px', width: '112px' }} className='bg-[#C1A559]' >XEM THÊM</button>
            </div>
          </div>
        </div>
      </div>
