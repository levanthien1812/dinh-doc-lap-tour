  ...
  return (
    ...
    <div className={`${style.flex} ${style.justify_between} px-16 py-12`}>
      <div className={`${style.col_5}`}>
        <div className={`${style.grid} ${style.payment_info} ${style.w_full} px-12`}>
          <p className={`${style.justify_center} ${style.flex} ${style.b} ${style.fs_25} py-6`}>
      ...
      <div className={`${style.grid} py-12 px-12 ${style.justify_items_center}`}>
    ...
    <div className={`${style.flex}`}>
      <div className={`${style.expire_time} ${style.grid} py-2 ${style.col_4}`}>
        <p className={`${style.text_center} py-3`}>Đơn hàng sẽ hết hạn sau:</p>
      ...
      <button className={`${style.btn_quayve} ${style.col_2}`} onClick={handleBack}>
        Quay về
      </button>
    </div>
  </div>
