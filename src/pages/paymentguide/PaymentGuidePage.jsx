...
function PaymentGuidePage() {
  ...
  return (
      ...
      <div className={`${style.container} ${style.w_100} ${style.bg_gray}`}>
        <button className={`${style.flex} px-8 py-8 ${style.align_center} ${style.fs_15} ${style.l}`} onClick={handleBackClick}>
        ...
        <div className={`px-16`}>
          ...
          <div className={`${style.grid} px-16 py-8`}>
            <div className={`${style.bg_white} px-16 py-8 fs-18`}>
              ...
              <button className={`${style.btn_next} mt-8`} onClick={handleContinueClick}>Tiếp tục</button>
            </div>
          </div>
        </div>
      </div>
