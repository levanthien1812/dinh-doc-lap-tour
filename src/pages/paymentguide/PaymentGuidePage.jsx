...
function PaymentGuidePage() {
  ...
  return (
    <div className="w-full bg-gray container">
      <div className="flex px-8 py-8 align-center fs-15 l">
      ...
      <div className="px-16">
        ...
        <div className="grid px-16 py-8">
          ...
          <div className=""><i>Chúng tôi sẽ kiểm tra và tiến hành xác nhận trạng thái của bạn trong vòng 24h. Hãy theo dõi ở trang <a href="#">chi tiết đặt vé</a></i></div>
          <button className="btn-next py-16 mt-8">Tiếp tục</button>
        </div>
        </div>
      </div>
    </div>
